...
public class GameConf {
	...
	public GameConf(int xSize, int ySize, int screenWidth, int screenHeight,
		...
		//System.out.println("here: "+PIECE_WIDTH+" "+PIECE_HEIGHT);
		PIECE_WIDTH = (int) (45 * scale + 0.5f);
		PIECE_HEIGHT = (int) (45 * scale + 0.5f);
        setBeginImage();
	}
	...
	public void setBeginImage(){
		...
		this.beginImageY = (screenHeight-500-PIECE_HEIGHT*ySize)/2+200;
    }
